...
void XuLyMenu(int menu, LIST& a, LIST& b)
{
	...
	case 6:
		...
		cout << "\nTap hop B = ";
		Output(b);
		cout << "\nHieu doi xung A va B : ";
		result = HieuDoiXung2TapHop(a, b);
		Output(result);
		break;
	case 7:
		cout << "\n7. Tich Descartes 2 tap hop\n";
	...
	case 8:
		...
		cout << "\nNhap phan tu x = ";
		cin >> x;
		if (KiemTraPhanTu(a, x) && KiemTraPhanTu(b, x))
			cout << "\nPhan tu x thuoc 2 tap hop A va B";
		else if (KiemTraPhanTu(a, x))
			cout << "\nPhan tu x thuoc tap hop A";
		else if (KiemTraPhanTu(b, x))
			cout << "\nPhan tu x thuoc tap hop B";
		else if (!(KiemTraPhanTu(a, x) && KiemTraPhanTu(b, x)))
	...
	case 9:
		...
		cout << "\nTap hop B = ";
		Output(b);
		if (KiemTraQuanHeBaoHam(a, b) && KiemTraQuanHeBaoHam(b, a))
			cout << "\nTap hop a bang tap hop b";
		else if (KiemTraQuanHeBaoHam(a, b))
			cout << "\nTap hop a bao ham trong tap hop b";
		else if (KiemTraQuanHeBaoHam(b, a))
